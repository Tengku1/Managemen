                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Tabel Rekap Bank</h6>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr class="{{ $item['status'] == 'Deactive' ? 'bg-secondary text-white' : '' }}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('bank.destroy') }}" method="post"
                                                    onsubmit="return confirm('Hapus Rekap Bank Ini ?')">
                                                    @csrf
                                                    @method("DELETE")
