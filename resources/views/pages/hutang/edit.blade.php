    ...
    <div class="card card-primary my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Ubah Hutang</h6>
            </div>
        </div>
        <form action="{{ route('hutang.update') }}" method="POST">
            {{ csrf_field() }}
            @method('PATCH')
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="kode_pemasok"
